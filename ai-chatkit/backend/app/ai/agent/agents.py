...
from ai.agent.policy_assistant import policy_assistant
from ai.agent.multi_agent import supervisor_agent


DEFAULT_AGENT = "policy-assistant"
...
agents: dict[str, Agent] = {
    "policy-assistant": Agent(description="A Policy Q&A intelligent assistant.", graph=policy_assistant),
