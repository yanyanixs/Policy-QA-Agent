...
_MODEL_TABLE = {
    ...
    DeepseekModelName.DEEPSEEK_V4_FLASH: "deepseek-v4-flash",
...
def get_model(model_name: AllModelEnum, /) -> ModelT:
    ...
    if model_name in DeepseekModelName._value2member_map_:
    ...
    if model_name in OllamaModelName._value2member_map_:
        ...
        return chat_ollama
    if model_name in FakeModelName._value2member_map_:
        return FakeToolModel(responses=["This is a test response from the fake model."])

    if model_name in TongYiModelName._value2member_map_:
